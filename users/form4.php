                            ...
                            <div class="main_div">
                                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                                    ...
                                    <div style="text-align:right;">
                                        <h6 style="font-weight:bold;font-size:15px;color:black">FORM NO. -4</h6>
                                        <h6 style="font-weight:bold;font-size:13px;color:black">(FOR GENERAL INFRASTRUCTURE)</h6>
                                    </div>
                                ...
                                <?php
                                    if(isset($_POST['bttnSave']))
                                    {
                                        ...
                                        VALUES ('$uid','$utype','$item','$specification','$totalquantityrequired','$qtystock','$addRequired','$justification','Pending','$dept','$papercoderefNo','$date','$reffno','4')";
                                        ...
                                        if($result){
                                            ...
                                            <center><a href='form4_pdf.php?id=$id' id='downloadlink'><span style='color:gray;'>Click Here to</span> Download PDF</a></center> .
                                            </div>";
                                            echo "
                                            <script>
                                            function hidediv(){
