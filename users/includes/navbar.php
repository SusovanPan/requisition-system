<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="requistionstatus.php">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span>Requistion status</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="requistionstatus_book.php">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span>Requistion status(Book)</span></a>
            </li>
            <!-- Divider -->
