                            ...
                            <div class="main_div">
                                ...
                                <?php
                                    if(isset($_POST['bttnSave']))
                                    {
                                        ...
                                        VALUES ('$uid','$utype','$item','$specification','$totalquantityrequired','$qtystock','$addRequired','$justification','Pending','$dept','$papercoderefNo','$date','$reffno','2')";
                                        ...
                                        if($result){
                                            ...
                                            <center><a href='form2_pdf.php?id=$id' id='downloadlink'><span style='color:gray;'>Click Here to</span> Download PDF</a></center> .
                                            </div>";
                                            echo "
                                            <script>
                                            function hidediv(){
