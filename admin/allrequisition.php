            ...
            <div class="card-body">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
			        <thead>
			            ...
			            <!--<th style="text-align:center;width:50px;">No Of </br><span style="font-size:10px">(Order)<span></th>-->
			        ...
			        <!--<td id="td_required"><?php echo $row2['newqtyrequired'];?></td>-->
			        ...
			        <td><?php 
                    if($row2['status']=="1"){
                        echo '<p><a href="requisition_status.php?id='.$row2['id'].
