                            ...
                            <div class="main_div">
                                ...
                                <?php
                                    if(isset($_POST['bttnSave']))
                                    {
                                        ...
                                        VALUES ('$uid','$utype','$item','$specification','$totalquantityrequired','$qtystock','$addRequired','$justification',0,'$dept','$papercoderefNo','$date','$reffno','1')";
                                        ...
                                        if($result){
                                            ...
                                            <center><a href='form1_pdf.php?id=$id' id='downloadlink'><span style='color:gray'>Click here to</span><u> Download PDF</u></a></center> .
                                            </div>";
                                            echo "
                                            <script>
                                            function hidediv(){
