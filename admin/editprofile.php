...
<!-- Main Content -->
    ...
    <div class="container-fluid">
        ...
        <div class="col-md-7">
			...
			<input type="file" name="admin_photo" class="form-control-file" id="exampleFormControlFile1">
            </div>
            
            <hr class="sidebar-divider d-none d-md-block">
            <div class="col-md-6">
               <button type="submit" name="update" class="btn btn-primary "><i class="fas fa-save" style="font-size:20px" ></i> Update</button>
            </div>
            </form>
        </div>
    </div>
