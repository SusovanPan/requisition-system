      ...
      <html lang="en" dir="ltr">
        ...
        hr{
          ...
          <div class="title">
            ...
            <div class="right">
              <span style="font-weight:bold;font-size:15px;color:black">FORM NO. -2</span></br>
              <span style="font-weight:bold;font-size:13px;color:black">(FOR COMPUTER/PRINTER/SCANNER/PERIPHERALS ETC.)</span>
            </div>
          </div>
          <div class="main_div">
          ...
          <table border="1" style="width:100%;">
            <tr>
              <td>___________________________________________</br>
              VERIFIED BY SYSTEM ADMINISTRATOR</br>
...
$dompdf->render();
$dompdf->stream($requisitionid.'_form2.pdf',array("Attachment"=>1));
?>
