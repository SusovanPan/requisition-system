...
<!-- Main Content -->
    ...
    <div class="container-fluid">
            ...
            <i class='fas fa-user-plus'></i>  Add Visiting Faculty
			</button>
			  ...
			  <div class="modal-dialog modal-dialog-scrollable" role="document">
			    <div class="modal-content">
			      ...
			      <div class="modal-body">
                        ...
                        <div class="form-group">
                            <input type="email" name="faculty_email" required class="form-control checking_email" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Email...">
						...
						<button type="submit" name="saveData" class="btn btn-primary "><i class='fas fa-plus-circle'></i>  Submit</button>
			      </div>
				  </form>
			...
			<div class="card shadow mb-4">
                        ...
                        <div class="card-body">
										...
										<?php
											...
											$query="SELECT * FROM users where designation='visiting'";
											$result = mysqli_query($con, $query) or die("Query Unsuccessful.");
											if(mysqli_num_rows($result)>0){
											?>
                                            <style>
			                                    ...
			                                    <tbody>
			                                        ...
			                                        <tr>
			                                            ...
			                                            <td>
                                                         ...
                                                         if ($astatus==1)
                                                         {
                                                            echo '<p><a href="vusers_status.php?id='.$row2['id'].
                                                        ...
                                                        <div class="modal fade" id="empModal" role="dialog">
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h4 class="modal-title"><i class='fas fa-user-alt' style='font-size:24px'></i>User Info</h4>
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <a class="btn btn-primary" style="background-color:#ed330e;border:none" href="delete.php?id=<?php echo $row2['id']; ?>"><i class='fas fa-skull-crossbones'></i> Delete</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
