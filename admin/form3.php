                            ...
                            <div class="main_div">
                                ...
                                <?php
                                    if(isset($_POST['bttnSave']))
                                    {
                                        ...
                                        $query="INSERT INTO requisition_book(uid,utype,dept,papercode,studentstrength,date,reffno,title,author,publisher,totalcopiesrequired,formno,availableinstock,newrequired,justification,status) 
                                        ...
                                        if($result){
                                            ...
                                            <center><a href='form3_pdf.php?id=$id' id='downloadlink'><span style='color:gray'>Click here to</span><u> Download PDF</u></a></center> .
                                            </div>";
                                            echo "
                                            <script>
                                            function hidediv(){
